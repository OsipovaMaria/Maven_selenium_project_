...
public enum MenuPage {
    ...
    private static final MenuPage[] menuItems = {APPEARANCE, CATALOG, COUNTRIES, CURRENCIES, CUSTOMERS, GEO_ZONES, LANGUAGES, MODULES, ORDERS, PAGES, REPORTS, SETTINGS, SLIDES, TAX, TRANSLATIONS, USERS, VQMODS};
